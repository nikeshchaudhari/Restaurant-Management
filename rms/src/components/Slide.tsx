        ...
        <div className="text-white flex  flex-col  mt-2 ">
          <div className="bg-[#1F354D] md:w-60 ml-2   lg:w-65  p-2 rounded transition-all  hover:bg-[#445971]  duration-300 cursor-pointer mb-5">
            <Link to="/dashboard/admin" className="flex pl-10 items-center">
              <LayoutDashboard />
              <h1 className="text-[20px] pl-2 font-normal ">Dashboard</h1>
            </Link>
          </div>
          <div className="bg-[#1F354D]  md:w-60 ml-2   lg:w-65  p-2 rounded transition-all  hover:bg-[#445971]  duration-300 cursor-pointer mb-5">
          ...
          <div className="bg-[#1F354D]  md:w-60 ml-2   lg:w-65  p-2 rounded transition-all  hover:bg-[#445971]  duration-300 cursor-pointer mb-5">
            <Link to="/dashboard/menu" className="flex pl-10 items-center">
              <SquareMenu />
              <h1 className="text-[20px]  pl-2 font-normal ">Menus</h1>
            </Link>
          </div>
          <div className="bg-[#1F354D] md:w-60 ml-2    lg:w-65  p-2 rounded transition-all  hover:bg-[#445971]  duration-300 cursor-pointer mb-5">
            <Link to="/dashboard/table" className="flex pl-10 items-center">
              <Table />
              <h1 className="text-[20px] pl-2 font-normal ">Tables</h1>
            </Link>
          </div>
          <div className="bg-[#1F354D] md:w-60 ml-2   lg:w-65  p-2 rounded transition-all  hover:bg-[#445971]  duration-300 cursor-pointer mb-5">
            <Link to="/dashboard/order" className="flex pl-10 items-center">
              <HandPlatter />
